...
// Create the wrapper class using composition
        val classBuilder = TypeSpec.classBuilder(wrapperClassName).primaryConstructor(
                ...
                PropertySpec.builder(
                    "original", ClassName(packageName, originalClassName)
...
// Generate wrapper methods
        for (method in methods) {
            ...
            val methodBuilder =
                FunSpec.builder(methodName).addModifiers(KModifier.PUBLIC, KModifier.FINAL).addParameters(parameters)
...
// Write the generated file
        try {
            ...
            if (kaptKotlinGeneratedDir != null) {
                ...
                // Correct way to write Kotlin files
            } else {
...
2. For each class containing annotated methods, it creates a corresponding wrapper
class.
